...
/datum/disease2/effect/alien
	...
	activate(var/mob/living/carbon/mob,var/multiplier)
		mob << "<span class='info'>You feel something tearing its way out of your stomach...</span>"
...
/datum/disease2/effect/greater/gunck
	...
	stage = 1
	activate(var/mob/living/carbon/mob,var/multiplier)
		mob << "<span class='info'>Mucous runs down the back of your throat.</span>"
...
/datum/disease2/effect/greater/suicide
	...
	activate(var/mob/living/carbon/mob,var/multiplier)
		...
		viewers(mob) << "<span class='info'><b>[mob.name] is holding \his breath. It looks like \he's trying to commit suicide.</b></span>"
...
/*/datum/disease2/effect/lesser/arm
	...
	activate(var/mob/living/carbon/mob,var/multiplier)
		...
		mob << "<span class='info'>You feel a sting in your right arm.</span>"*/
