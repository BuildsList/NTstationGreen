...
/datum/turntable_soundtrack/cheekibreeki
	f_name = "M"
	name = "aslinu Poymal"
	path = 'sound/turntable/cheekibreeki.ogg'

/datum/turntable_soundtrack/spressasshole
	f_name = "S"
	name = "pace Asshole"
	path = 'sound/turntable/spaceasshole.ogg'

/datum/turntable_soundtrack/gaybar
	f_name = "G"
	name = "ay Bar"
	path = 'sound/turntable/gaybar.ogg'

/datum/turntable_soundtrack/removekebab
	f_name = "R"
	name = "emove Kebab"
	path = 'sound/turntable/serbiastrong.ogg'

/datum/turntable_soundtrack/spy
	f_name = "S"
	name = "py vs. Spy"
	path = 'sound/turntable/spy.ogg'

/datum/turntable_soundtrack/lolyjazz
	f_name = "T"
	name = "hinking Of Baby"
	path = 'sound/turntable/tobjazz.ogg'
*/