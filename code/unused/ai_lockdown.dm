/*	world << "<span class='info'>Lockdown initiated by [usr.name]!</span>"
...
/*	src.verbs -= /mob/living/silicon/ai/proc/lockdown
	...
	usr << "<span class='info'>Disable lockdown command enabled!</span>"
	winshow(usr,"rpane",1)
*/
...
/mob/living/silicon/ai/proc/disablelockdown()
	...
	world << "<span class='info'>Lockdown cancelled by [usr.name]!</span>"
...
/*	src.verbs -= /mob/living/silicon/ai/proc/disablelockdown
	src.verbs += /mob/living/silicon/ai/proc/lockdown
	usr << "<span class='info'>Disable lockdown command removed until lockdown initiated again!</span>"
	winshow(usr,"rpane",1)
*/