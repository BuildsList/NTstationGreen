...
//	user << "<span class='info'>There seem to be some parts missing from this server. They should arrive on the station in a few days, give or take a few Centcom delays.</span>"
