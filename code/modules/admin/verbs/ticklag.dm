...
/client/proc/ticklag()
	...
	set desc = "Sets a new tick lag. Recommend you don't mess with this too much! Stable, time-tested ticklag value is 0.6"
	...
	if(newtick && newtick <= 2 && newtick > 0)
		...
		src << "<span class='info'>Error: ticklag(): Invalid world.ticklag value. No changes made.</span>"
