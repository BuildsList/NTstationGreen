...
/datum/admins/proc/restart()
	...
	if(confirm == "Cancel")
		return
	if(confirm == "Yes")
		world << "<span class='warning'><b>Restarting world!</b> \blue Initiated by [usr.client.holder.fakekey ? "Admin" : usr.key]!</span>"
...
/datum/admins/proc/announce()
	...
	if(message)
		...
		world << "<span class='info'><b>[usr.client.holder.fakekey ? "Administrator" : usr.key] Announces:</b>\n \t [message]</span>"
...
/datum/admins/proc/immreboot()
	...
	if( alert("Reboot server?",,"Yes","No") == "No")
		return
	world << "<span class='warning'><b>Rebooting world!</b> \blue Initiated by [usr.client.holder.fakekey ? "Admin" : usr.key]!</span>"
