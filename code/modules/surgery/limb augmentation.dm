...
/datum/surgery_step/add_limb/success(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
	if(L)
		if(ishuman(target))
			...
			switch(target_zone)
				if("r_leg")
					H.organs += new /obj/item/augment/r_leg(src)
				if("l_leg")
					H.organs += new /obj/item/augment/l_leg(src)
				if("r_arm")
					H.organs += new /obj/item/augment/r_arm(src)
				if("l_arm")
					H.organs += new /obj/item/augment/l_arm(src)
				if("head")
					H.organs += new /obj/item/augment/head(src)
				if("chest")
					...
					H.organs += new /obj/item/augment/chest(src)
