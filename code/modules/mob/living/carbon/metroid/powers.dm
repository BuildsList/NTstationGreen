					...
					if(health > -70)
						...
						for(var/mob/living/carbon/slime/met in view())
							if(met.Victim == M && met != src)
								...
								return
						src << "<span class='info'><i>I have latched onto the subject and begun feeding...</i></span>"
						M << "<span class='info'><b>The [src.name] has latched onto your head!</b></span>"
						Feedon(M)
...
/mob/living/carbon/slime/proc/Feedon(var/mob/living/carbon/M)
	...
	//if(M.client) M << "<span class='info'>You legs become paralyzed!</span>"
	if(is_adult)
	...
	while(Victim && M.health > -70 && stat != 2)
		...
		if(Adjacent(M))
			...
			if(prob(15) && M.client && istype(M, /mob/living/carbon))
				M << "<span class='info'>[pick("You can feel your body becoming weak!", \
			...
			if(istype(M, /mob/living/carbon))
				...
				if(prob(25))
					src << "<span class='info'><i>[pick("This subject is incompatable", \
