	...
	proc/handle_disabilities()
		...
		if (getBrainLoss() >= 60 && stat != 2)
			if (prob(3))
				switch(pick(1,2,3))
					if(1)
						say(pick("биз воздуха блоб будит ивалюцианиравать???", "; КАПИТАН ГАНДОН!", "[pick("", "этот ебаный предатель")] ЭТАТ!! ПИДАР грифонит мин&#255; ПАМАГИТИ!!!", "ты можишь мине дать [pick("телекинезис","халка","епилепсию")]?", "; ХОС ХУЕСОС!", "Мажна &#255; буду алиумом???", "Я ХОТЕТЬ ПАГЛАДИТЬ этих маКаК", "пиристань грифонеть мин&#255;!!!!", "ДЕМАН АСТАНАВИСЬ", "; ХОП ТРЕЙТОР!"))
					if(2)
