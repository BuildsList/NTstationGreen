	...
	proc/handle_disabilities()
		if (disabilities & EPILEPSY)
			if ((prob(1) && paralysis < 1))
				...
				for(var/mob/O in viewers(src, null))
					if(O == src)
						continue
					O.show_message(text("\red <B>[src] впадает в припадок!"), 1)
				Paralyse(10)
				Jitter(1000)
			...
			if ((prob(10) && paralysis <= 1))
				...
				switch(rand(1, 3))
					if(1)
						emote("дергаетс&#255;")
					if(2 to 3)
						say("[prob(50) ? ";" : ""][pick("ЕБАНЫЙ", "НАХУЙ", "БЛЯДЬ", "ШЛЮХА", "ХУЕСОС", "ПИЗДА", "СУКА")]")
		...
		if (getBrainLoss() >= 60 && stat != 2)
			if (prob(3))
				switch(pick(1,2,3))
					if(1)
						say(pick("МАЙ ЛИТЛ ПОНИ - ЛУЧШИЙ МУЛЬТИК!", "биз воздуха блоб будит ивалюцианиравать???", "; КАПИТАН ГАНДОН!", "[pick("", "этот ебаный предатель")] ЭТАТ!! ПИДАР грифонит мин&#255; ПАМАГИТИ!!!", "ты можишь мине дать [pick("телекинезис","халка","епилепсию")]?", "; ХОС ХУЕСОС!", "Мажна &#255; буду алиумом???", "Я ХОТЕТЬ ПАГЛАДИТЬ этих маКаК", "пиристань грифонеть мин&#255;!!!!", "ДЕМАН АСТАНАВИСЬ", "; ХОП ТРЕЙТОР!"))
					if(2)
						say(pick("НАЧАЛЬНИК!","где детонатор", "соблазни мен&#255;", "Хочешь &#255; насру", "РАЗГЕРМА У КЛОУНА", "ВВВВВВРААААААААААААААААВВВВВВР!!!", "КРАСНОЕ ЛЕТАИТ БЫСТРЕ", "ЗА ИМПЕРАТОРА", "лолбл&#255;", "эти ебаные дворфы, ебаные дворфы", "ЗА КОСМИЧЕСКИ ДЕСАНТ", "он сделал эта дл&#255; хаоса", "ЯЯЯЗЬ!!!!", "как мин&#255;ть руки!!!???", "ойбл&#255; &#255; кончил в штаны", "хачу сми&#255;тс&#255; п&#255;ть минут", "ЭТОТ ПИДОРАС ОБОСРАЛСЯ!", "ГРАФОН КАК В КРУЗИСЕ!"))
					if(3)
						emote("drool")
