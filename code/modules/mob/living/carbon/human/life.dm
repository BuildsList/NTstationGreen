	...
	proc/handle_disabilities()
		...
		if (getBrainLoss() >= 60 && stat != 2)
			if (prob(3))
				switch(pick(1,2,3))
					if(1)
						say(pick("МАЙ ЛИТЛ ПОНИ - ЛУЧШИЙ МУЛЬТИК!", "биз воздуха блоб будит ивалюцианиравать???", "; КАПИТАН ГАНДОН!", "[pick("", "этот ебаный предатель")] шораст эльф грифонит миня ПАМАГИТИ!!!", "ты можишь мине дать [pick("телекинезис","халка","епилепсию")]?", "; ХОС ХУЕСОС!", "Мажна я буду алиумом???", "Я ХОТЕТЬ ПАГЛАДИТЬ этих маКаК", "пиристань грифонеть миня!!!!", "ДЕМАН АСТАНАВИСЬ", "; ХОП ТРЕЙТОР!"))
					if(2)
						say(pick("НАЧАЛЬНИК!","где детонатор", "соблазни меня", "Хочешь я насру", "НАС ОКРУЖИЛИ, ВЫЗЫВАЙ ПОДКРЕПЛЕНИЕ", "РААААААААААААААААР!!!", "гонна го фаст", "ЗА ИМПЕРАТОРА", "лолбля", "эти ебаные дворфы, ебаные дворфы", "ЗА КОСМИЧЕСКИ ДЕСАНТ", "он сдилал эта для хаоса", "ЯЯЯЗЬ!!!!", "щитсповн", "ойбля я кончил в штаны", "хачу смиятся пять минут", "ЭТОТ ПИДОРАС ОБОСРАЛСЯ!", "ГРАФОН КАК В КРУЗИСЕ!"))
					if(3)
						emote("drool")
