...
/obj/machinery/field/proc/shock(mob/living/user as mob)
	...
	if(isliving(user))
		...
		if(iscarbon(user))
			...
			user.visible_message("<span class='info'>[user.name] was shocked by the [src.name]!</span>", \
			"<span class='info'><B>You feel a powerful shock course through your body sending you flying!</B></span>", \
			"<span class='info'>You hear a heavy electrical crack</span>")
			...
			user.visible_message("<span class='info'>[user.name] was shocked by the [src.name]!</span>", \
			"<span class='info'><B>Energy pulse detected, system damaged!</B></span>", \
			"<span class='info'>You hear an electrical crack</span>")
