...
/obj/machinery/field/proc/shock(mob/living/user as mob)
	...
	if(isliving(user))
		...
		if(iscarbon(user))
			...
			user.visible_message("<span class=\'warning\'>[user.name] was shocked by the [src.name]!</span>", \
			"<span class=\'warning\'><B>You feel a powerful shock course through your body sending you flying!</B></span>", \
			...
			user.visible_message("<span class=\'warning\'>[user.name] was shocked by the [src.name]!</span>", \
			"<span class=\'warning\'><B>Energy pulse detected, system damaged!</B></span>", \
