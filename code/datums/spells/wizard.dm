...
/obj/effect/proc_holder/spell/targeted/genetic/mutate
	...
	invocation_type = "shout"
	message = "<span class='info'>You feel strong! You feel a pressure building behind your eyes!</span>"
	range = -1
	include_user = 1
	centcom_cancast = 0

	mutations = list(/datum/organic_effect/laser, /datum/organic_effect/hulk)
	duration = 300
...
/obj/effect/proc_holder/spell/targeted/trigger/blind
	...
	invocation = "STI KALY"
	invocation_type = "whisper"
	message = "<span class='info'>Your eyes cry out in pain!</span>"
	cooldown_min = 50 //12 deciseconds reduction per rank
