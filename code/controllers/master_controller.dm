...
datum/controller/game_controller/proc/setup_objects()
	...
	world << "<span class=\'warning\'>\b Initializing pipe networks...</span>"
	sleep(-1)
	for(var/obj/machinery/atmospherics/machine in world)
		machine.build_network()

	world << "<span class=\'warning\'>\b Initializing atmos machinery...</span>"
	sleep(-1)
	...
	world << "<span class=\'warning\'>\b Making a mess...</span>"
	sleep(-1)
	for(var/turf/simulated/floor/F in world)
		F.MakeDirty()

	world << "<span class=\'warning\'>\b Initializations complete.</span>"
	sleep(-1)
