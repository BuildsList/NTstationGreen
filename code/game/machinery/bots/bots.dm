...
/obj/machinery/bot/attack_alien(var/mob/living/carbon/alien/user as mob)
	...
	src.visible_message("<span class='info'><B>[user] has slashed [src]!</B></span>")
...
/obj/machinery/bot/attack_animal(var/mob/living/simple_animal/M as mob)
	...
	src.visible_message("<span class='info'><B>[M] has [M.attacktext] [src]!</B></span>")
	...
	if(istype(W, /obj/item/weapon/screwdriver))
		...
		if(health < maxhealth)
			if(open)
				...
				user.visible_message("<span class='info'>[user] repairs [src]!</span>","<span class='info'>You repair [src]!</span>")
			else
