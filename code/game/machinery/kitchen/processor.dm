...
/obj/machinery/processor/attackby(var/obj/item/O as obj, var/mob/user as mob)
	if(src.processing)
		user << "<span class='info'>The processor is in the process of processing.</span>"
		return 1
	if(src.contents.len > 0) //TODO: several items at once? several different items?
		user << "<span class='info'>Something is already in the processing chamber.</span>"
		return 1
	...
	if (!P)
		user << "<span class='info'>That probably won't blend.</span>"
		return 1
...
/obj/machinery/processor/attack_hand(var/mob/user as mob)
	...
	if(src.contents.len == 0)
		user << "<span class='info'>The processor is empty.</span>"
		return 1
