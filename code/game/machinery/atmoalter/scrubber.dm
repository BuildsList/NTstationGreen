...
/obj/machinery/portable_atmospherics/scrubber/huge
	...
	attack_hand(var/mob/user as mob)
		usr << "<span class='info'>You can't directly interact with this machine. Use the area atmos computer.</span>"
	...
	attackby(var/obj/item/weapon/W as obj, var/mob/user as mob)
		if(istype(W, /obj/item/weapon/wrench))
			if(on)
				user << "<span class='info'>Turn it off first!</span>"
				return

			anchored = !anchored
			playsound(src.loc, 'sound/items/Ratchet.ogg', 50, 1)
			user << "<span class='info'>You [anchored ? "wrench" : "unwrench"] \the [src].</span>"
...
/obj/machinery/portable_atmospherics/scrubber/huge/stationary
	...
	attackby(var/obj/item/weapon/W as obj, var/mob/user as mob)
		if(istype(W, /obj/item/weapon/wrench))
			user << "<span class='info'>The bolts are too tight for you to unscrew!</span>"
			return
