	...
	for(i=0, i<src.number, i++)
		...
		spawn(0)
			...
			for(i=0, i<pick(0,1,1,1,2,2,2,3), i++)
				sleep(10)
				step(smoke,direction)
			spawn(200*0.75+rand(10,30))
				if (smoke) smoke.delete()
				src.total_smoke--


/datum/effect/effect/system/smoke_spread/bad
	smoke_type = /obj/effect/effect/bad_smoke

/datum/effect/effect/system/smoke_spread/sleepy
	smoke_type = /obj/effect/effect/sleep_smoke


/datum/effect/effect/system/smoke_spread/harmless
	smoke_type = /obj/effect/effect/harmless_smoke