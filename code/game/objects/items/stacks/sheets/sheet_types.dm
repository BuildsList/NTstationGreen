...
var/global/list/datum/stack_recipe/metal_recipes = list ( \
	...
	new/datum/stack_recipe("knife blade", /obj/item/buildingobject/butterfly/blade, 6, time = 20), \
	new/datum/stack_recipe("handgun slide", /obj/item/buildingobject/glock/slide, 10, time = 30), \
	null, \
...
var/global/list/datum/stack_recipe/plasteel_recipes = list ( \
	...
	new/datum/stack_recipe("knife grip", /obj/item/buildingobject/butterfly/handle, 4, time = 20), \
	new/datum/stack_recipe("handgun grip", /obj/item/buildingobject/glock/grip, 6, time = 30), \
)
