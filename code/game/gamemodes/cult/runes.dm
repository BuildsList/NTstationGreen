...
/////////////////////////////////////////FOURTEETH RUNE
		...
		communicate()
			...
			for(var/datum/mind/H in ticker.mode.cult)
				if (H.current)
					H.current << "<span class='warning'>\b [input]</span>"
			return 1
					...
					if(H.mind == Cult.sacrifice_target)
						if(cultsinrange.len >= 3)
							...
							for(var/mob/living/carbon/C in cultsinrange)
								C << "<span class='warning'>The Geometer of Blood accepts this sacrifice, your objective is now complete.</span>"
								C << "<span class='warning'>He is pleased!</span>"
								sac_grant_word(C)
								sac_grant_word(C)
						...
						if(cultsinrange.len >= 3)
							if(H.stat !=2)
								for(var/mob/living/carbon/C in cultsinrange)
									C << "<span class='warning'>The Geometer of Blood accepts this sacrifice.</span>"
									sac_grant_word(C)
									stone_or_gib(H)
							else
								if(prob(60))
