...
/datum/game_mode/proc/grant_runeword(mob/living/carbon/human/cult_mob, var/word)
	...
	cult_mob << "<span class=\'warning\'>[pick(</span>"You remember something from the dark teachings of your master","You hear a dark voice on the wind","Black blood oozes into your vision and forms into symbols","You catch a brief glimmer of the otherside")]... [wordexp]"
