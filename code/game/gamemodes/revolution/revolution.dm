...
/datum/game_mode/proc/greet_revolutionary(var/datum/mind/rev_mind, var/you_are=1)
	var/obj_count = 1
	if (you_are)
		rev_mind.current << "<span class='info'><FONT size = 3><B>Вы &#255;вл&#255;етесь одним из глав революционного движени&#255;!</B></FONT></span>"
...
/datum/game_mode/proc/add_revolutionary(datum/mind/rev_mind)
	...
	rev_mind.current << "<span class='info'><FONT size = 3> Вы теперь революционер! Продвигайте свою идею в массы. Не вредите тем, кто с вами по одну сторону барикад. Ваши товарищи будут отмечены красной буквой \"R\" над головой, а ваши лидеры будут отмечены синей буквой \"R\" над головой. Помогите им свергнуть глав и сделайте вашу революцию успешной!</FONT></span>"
...
/datum/game_mode/proc/remove_revolutionary(datum/mind/rev_mind , beingborged)
	if(rev_mind in revolutionaries)
		...
		if(beingborged)
			rev_mind.current << "<span class='info'><FONT size = 3><B>Программное обеспечение уничтожило последстви&#255; нейронного перепрограммировани&#255; и вы забыли всё, чтобыло после вспышки.</B></FONT></span>"

		else
			rev_mind.current << "<span class='info'><FONT size = 3><B>Вам промыли мозги! Вы больше не верите в идеалы революции! Вы забыли всё, чтобыло после вспышки... в голове только им&#255; того, кто ослепил вас...</B></FONT></span>"
...
/datum/game_mode/revolution/declare_completion()
	if(finished == 1)
		world << "<span class='info'><FONT size = 3><B> Ло&#255;листы были убиты или покинули станцию. Победа революции!</B></FONT></span>"
	else if(finished == 2)
		world << "<span class='info'><FONT size = 3><B> Ло&#255;листы смогли остановить революцию!</B></FONT></span>"
	..()
	return 1
