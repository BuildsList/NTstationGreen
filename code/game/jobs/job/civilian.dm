...
/datum/job/cargo_tech
	...
	r_supervisors = "завхозу и главе персонала"
	selection_color = "#dddddd"
...
/datum/job/clown
	...
	spawn_positions = 1
	supervisors = "the head of personnel"
	r_supervisors = "главе персонала и самому себе"
	selection_color = "#dddddd"
...
/datum/job/clown/equip_items(var/mob/living/carbon/human/H)
	...
	H.add_organic_effect(/datum/organic_effect/clumsy)
	H.rename_self("clown")
...
/datum/job/mime
	...
	spawn_positions = 1
	supervisors = "the head of personnel"
	r_supervisors = "главе персонала и своим чувствам"
	selection_color = "#dddddd"
